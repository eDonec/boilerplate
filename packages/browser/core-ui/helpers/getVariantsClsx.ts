...
export const getVariantsClsx = (
  ...
  if (success)
    return [
      ...
      soft
        ? `dark:bg-success-900 dark:bg-opacity-80 bg-success-100 text-success-700 hover:bg-success-200`
        : `dark:bg-success-900 bg-success-200 text-success-700 hover:bg-success-300`,
      (ghost || outline) &&
        `!bg-transparent dark:!bg-transparent dark:hover:!bg-success-800`,
      `dark:text-success-200 dark:hover:bg-success-800 dark:disabled:bg-gray-900`,
    ];
  if (danger)
    return [
      ...
      soft
        ? `dark:bg-danger-900 dark:bg-opacity-80 bg-danger-100 text-danger-600 hover:bg-danger-200`
        : `dark:bg-danger-900 bg-danger-200 text-danger-700 hover:bg-danger-300`,
      (ghost || outline) &&
        `!bg-transparent dark:!bg-transparent dark:hover:!bg-danger-800`,
      `dark:text-danger-200 dark:hover:bg-danger-800 dark:disabled:bg-gray-900`,
    ];
  if (warning)
    return [
      ...
      soft
        ? `dark:bg-warning-900 dark:bg-opacity-80 bg-warning-100 text-warning-600 hover:bg-warning-200`
        : `dark:bg-warning-900 bg-warning-200 text-warning-700 hover:bg-warning-300`,
      (ghost || outline) &&
        `!bg-transparent dark:!bg-transparent dark:hover:!bg-warning-800`,
      `dark:text-warning-200 dark:hover:bg-warning-800 dark:disabled:bg-gray-900`,
    ];
  if (info)
    return [
      ...
      soft
        ? `dark:bg-info-900 dark:bg-opacity-80 bg-info-100 text-info-600 hover:bg-info-200`
        : `dark:bg-info-900 bg-info-200 text-info-700 hover:bg-info-300`,
      (ghost || outline) &&
        `!bg-transparent dark:!bg-transparent dark:hover:!bg-info-800`,
      `dark:text-info-200 dark:hover:bg-info-800 dark:disabled:bg-gray-900`,
    ];
  if (gray)
    return [
      outline && !soft && "border border-gray-500 dark:border-gray-50",
      outline && soft && "border border-gray-200 dark:border-gray-50",
      soft
        ? `dark:bg-gray-900 dark:bg-opacity-80 bg-gray-100 text-gray-600 hover:bg-gray-200`
        : `dark:bg-gray-700 bg-gray-200 text-gray-700 hover:bg-gray-300`,
      (ghost || outline) &&
        `!bg-transparent dark:!bg-transparent dark:hover:!bg-gray-600`,
      `dark:text-gray-300 dark:hover:bg-gray-600 dark:disabled:bg-gray-900`,
    ];
