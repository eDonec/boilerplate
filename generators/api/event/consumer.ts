...
type OnMessageReceivedFunc<
  EventName extends MICROSERVICE_NAME_UPPERCASE_PLACEHOLDEREvents
> = (
  message: MICROSERVICE_NAME_UPPERCASE_PLACEHOLDEREventsPayload[EventName],
  key?: EventName
) => void;

type TSubscriber<
  EventName extends MICROSERVICE_NAME_UPPERCASE_PLACEHOLDEREvents
> = (onMessageReceived: OnMessageReceivedFunc<EventName>) => Promise<void>;

type Subscribers = {
  [eventName in MICROSERVICE_NAME_UPPERCASE_PLACEHOLDEREvents]: TSubscriber<eventName>;
};
class MICROSERVICE_NAME_UPPERCASE_PLACEHOLDERConsumer {
  ...
  constructor() {
    ...
    this.subscribeToAll = (
      onMessageReceived: OnMessageReceivedFunc<MICROSERVICE_NAME_UPPERCASE_PLACEHOLDEREvents>
    ) => {
...
export default MICROSERVICE_NAME_UPPERCASE_PLACEHOLDERConsumer;
