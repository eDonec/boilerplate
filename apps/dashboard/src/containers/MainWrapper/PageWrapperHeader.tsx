...
const PageWrapperHeader: React.FC<PageWrapperHeaderProps> = ({
  ...
  <div className="mx-auto w-4/5 pt-4 md:w-11/12">
    <div className="flex justify-between">
      <div className="flex">
        <div className="bg-primary-200 h-20  w-20 rounded-full p-4">
          {Icon && (
            <Icon className="stroke-primary-600 dark:stroke-primary-900 dark:fill-primary-900 fill-primary-600 h-full w-full" />
          )}
        </div>
