...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto my-16 px-10">
      ...
      <h1 className="pb-8">Privacy Policy for Donec</h1>

      <p>
        At eDonec, accessible from edonec.com, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by eDonec and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in eDonec. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </p>

      <h2 className="pb-4 pt-8">Consent</h2>
      ...
      <h2 className="pb-4 pt-8">Information we collect</h2>
      ...
      <h2 className="pb-4 pt-8">How we use your information</h2>
      ...
      <h2 className="pb-4 pt-8">Log Files</h2>

      <p>
        eDonec follows a standard procedure of using log files. These files log
      ...
      <h2 className="pb-4 pt-8">Cookies and Web Beacons</h2>

      <p>
        Like any other website, eDonec uses &apos;cookies&apos;. These cookies
      ...
      <h2 className="pb-4 pt-8">Google DoubleClick DART Cookie</h2>
      ...
      <h2 className="pb-4 pt-8">Our Advertising Partners</h2>
      ...
      <h2 className="pb-4 pt-8">Advertising Partners Privacy Policies</h2>

      <p>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of eDonec.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on eDonec, which are sent directly
      ...
      <p>
        Note that eDonec has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>

      <h2 className="pb-4 pt-8">Third Party Privacy Policies</h2>

      <p>
        eDonec&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <h2 className="pb-4 pt-8">GDPR Data Protection Rights</h2>
      ...
      <h2 className="pb-4 pt-8">Children&apos;s Information</h2>
      ...
      <p>
        eDonec does not knowingly collect any Personal Identifiable Information
      ...
      <h2 className="pb-4 pt-8">Changes to This Privacy Policy</h2>
      ...
      <h2 className="pb-4 pt-8">Contact Us</h2>
